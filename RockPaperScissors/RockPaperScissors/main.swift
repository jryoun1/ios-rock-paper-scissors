...
func judgmentWinDrawLose(computerHand : Int, userHand : Int) -> String {
    ...
    let Scissors : Int = RockPaperScissors.Scissors.rawValue
    let Rock : Int = RockPaperScissors.Rock.rawValue
    switch computerHand {
    case Scissors :
        if userHand == Scissors { result = "비겼습니다!"; print(result) }
        else if userHand == Rock { result = "이겼습니다!"; print(result) }
        else { result = "졌습니다!"; print(result) }
    case Rock :
        if userHand == Scissors { result = "졌습니다!"; print(result) }
        else if userHand == Rock { result = "비겼습니다!"; print(result) }
        else { result = "이겼습니다!"; print(result) }
    default :
        if userHand == Scissors { result = "이겼습니다!"; print(result) }
        else if userHand == Rock { result = "졌습니다!"; print(result) }
        else { result = "비겼습니다!"; print(result) }
    }
    return result
}
...
func judgementMukChiPaWinLose(computerHand : Int, userHand : Int, turn : String) -> String {
    ...
    let Muk : Int = mukChiPa.Muk.rawValue
    let Chi : Int = mukChiPa.Chi.rawValue
        switch computerHand {
        case Muk :
